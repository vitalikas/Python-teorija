events = [
    {
        ...
        "sessionId": "0:NynteeXG:MYlskrqZbcmXNSFEJaZIsNVGeDLLpmct11",
    ...
    },
    {
        ...
        "remoteHost": "test0",
        "partyId": "0:aFpLgMBB:BcYmReGvvFOxrDyWtwCqiHHYMmKlLWiH",
        "sessionId": "0:NynteeXG:MYlskrqZbcmXNSFEJaZIsNVGeDLLpmct99",
...
answer1 = "Всего itemViewEvent событий:"
answer2 = "Всего itemBuyEvent событий:"

for event in events:
    # print (event["eventType"])
    if event["eventType"] == "itemViewEvent":
        itemViewCount = itemViewCount + 1
    if event["eventType"] == "itemBuyEvent":
        itemBuyCount = itemBuyCount + 1

print(answer1, itemViewCount)
print(answer2, itemBuyCount)


for event in events:
    if not event["detectedDuplicate"]:
        print("No duplicate")
    else:
        print("Duplicate detected")


min_ = events[0]["timestamp"]
sessionId_ = events[0]["sessionId"]
for event in events:
    # print(event["timestamp"])
    if event["timestamp"] < min_:
        min_ = event["timestamp"]
        sessionId_ = events["sessionId"]
